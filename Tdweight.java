...
public class Tdweight
{
	...
	{
		BufferedReader file=new BufferedReader(new FileReader("C://Users/Dell/Documents/Desktop/dmcode/t&d.csv"));
		...
		//writing to file
		PrintWriter out=new PrintWriter(new File("output_tdweight.csv"));
