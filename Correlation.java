...
public class Correlation {
    public static void main(String[] args) throws Exception {
        BufferedReader br=new BufferedReader(new FileReader("C://Users/DELL/Documents/Desktop/dmcode/correlation.csv"));
        ...
        for(int i=0;i<data.size()-1;i++){
            for(int j=i+1;j< data.size();j++){
                System.out.println("--------Cor= n(A U B) / (n(A)*n(B))------- \n Correlation between "+data.get(i).get(0)+" and "+data.get(j).get(0)+":"+findCorrelation(i,j,data));
